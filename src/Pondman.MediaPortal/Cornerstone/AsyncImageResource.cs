...
namespace Pondman.MediaPortal
{
    ...
    public class AsyncImageResource
    {
        ...
        public AsyncImageResource(ILogger logger)
        {
            _logger = logger;
        }
        ...
        public bool Active
        {
            ...
            set
            {
                ...
                newThread.Name = "AsyncImageResource";
                newThread.Start();
            }
        }
        ...
        {
            return "[AIR:" + filename.GetHashCode() + "]";
        }
        ...
        public Image LoadImageFastFromFile(string filename)
        {
            ...
            {
                _logger.Warn("Failed to load image {0}: {1}", filename, e.Message);
                image = null;
            }
